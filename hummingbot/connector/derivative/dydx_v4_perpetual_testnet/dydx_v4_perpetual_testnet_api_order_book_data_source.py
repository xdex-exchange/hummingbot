...
from hummingbot.connector.derivative.dydx_v4_perpetual_testnet import (
    dydx_v4_perpetual_testnet_constants as CONSTANTS,
    dydx_v4_perpetual_testnet_web_utils as web_utils,
)
...
if TYPE_CHECKING:
    from hummingbot.connector.derivative.dydx_v4_perpetual_testnet.dydx_v4_perpetual_testnet_derivative import (
        DydxV4PerpetualTestnetDerivative,
    )


class DydxV4PerpetualTestnetAPIOrderBookDataSource(PerpetualAPIOrderBookDataSource):
    FULL_ORDER_BOOK_RESET_DELTA_SECONDS = sys.maxsize

    def __init__(
        self,
        trading_pairs: List[str],
        connector: "DydxV4PerpetualTestnetDerivative",
