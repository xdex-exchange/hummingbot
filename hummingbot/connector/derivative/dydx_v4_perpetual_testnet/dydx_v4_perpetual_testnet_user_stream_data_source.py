...
class DydxV4PerpetualTestnetUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    async def _connected_websocket_assistant(self) -> WSAssistant:
        if self._ws_assistant is None:
            ...
            subaccount_id = (
                f"{self._connector._dydx_v4_perpetual_testnet_chain_address}/{self._connector.subaccount_id}"
            )
