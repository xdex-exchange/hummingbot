...
import hummingbot.connector.derivative.dydx_v4_perpetual_testnet.dydx_v4_perpetual_testnet_constants as CONSTANTS
from hummingbot.connector.constants import s_decimal_0, s_decimal_NaN
from hummingbot.connector.derivative.dydx_v4_perpetual_testnet import dydx_v4_perpetual_testnet_web_utils as web_utils
from hummingbot.connector.derivative.dydx_v4_perpetual_testnet.data_sources.dydx_v4_testnet_data_source import (
    DydxPerpetualV4TestnetClient,
)
from hummingbot.connector.derivative.dydx_v4_perpetual_testnet.dydx_v4_perpetual_testnet_api_order_book_data_source import (
    DydxV4PerpetualTestnetAPIOrderBookDataSource,
)
from hummingbot.connector.derivative.dydx_v4_perpetual_testnet.dydx_v4_perpetual_testnet_user_stream_data_source import (
    DydxV4PerpetualTestnetUserStreamDataSource,
)
...
class DydxV4PerpetualTestnetDerivative(PerpetualDerivativePyBase):
    web_utils = web_utils

    def __init__(
        self,
        client_config_map: "ClientConfigAdapter",
        dydx_v4_perpetual_testnet_secret_phrase: str,
        dydx_v4_perpetual_testnet_chain_address: str,
        trading_pairs: Optional[List[str]] = None,
        trading_required: bool = True,
        domain: str = CONSTANTS.DEFAULT_DOMAIN,
    ):
        self._dydx_v4_perpetual_testnet_secret_phrase = dydx_v4_perpetual_testnet_secret_phrase
        self._dydx_v4_perpetual_testnet_chain_address = dydx_v4_perpetual_testnet_chain_address
        self._trading_pairs = trading_pairs
        self._trading_required = trading_required
        self._domain = domain
        self._client_order_id_nonce_provider = NonceCreator.for_microseconds()

        self._tx_client: DydxPerpetualV4TestnetClient = self._create_tx_client()
    ...
    async def _update_balances(self):
        path = f"{CONSTANTS.PATH_SUBACCOUNT}/{self._dydx_v4_perpetual_testnet_chain_address}/subaccountNumber/{self.subaccount_id}"
    ...
    async def _request_order_fills(self, order: InFlightOrder) -> Dict[str, Any]:
        ...
        body_params = {
            "address": self._dydx_v4_perpetual_testnet_chain_address,
    ...
    def _create_tx_client(self) -> DydxPerpetualV4TestnetClient:
        return DydxPerpetualV4TestnetClient(
            self._dydx_v4_perpetual_testnet_secret_phrase, self._dydx_v4_perpetual_testnet_chain_address, connector=self
        )

    def _create_order_book_data_source(self) -> DydxV4PerpetualTestnetAPIOrderBookDataSource:
        return DydxV4PerpetualTestnetAPIOrderBookDataSource(
            self.trading_pairs,
            connector=self,
    ...
    def _create_user_stream_data_source(self) -> UserStreamTrackerDataSource:
        return DydxV4PerpetualTestnetUserStreamDataSource(api_factory=self._web_assistants_factory, connector=self)
